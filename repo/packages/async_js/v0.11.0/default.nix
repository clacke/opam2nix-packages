...
pkgs.stdenv.mkDerivation 
{
  ...
  src = fetchurl 
  {
    sha256 = "1rrqdwzqqqxpxlislcn31bhplz858nlwlg24hs80ig6cdfz0x614";
    url = "https://ocaml.janestreet.com/ocaml-core/v0.11/files/async_js-v0.11.0.tar.gz";
  };
}
